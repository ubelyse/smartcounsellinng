...
public class MoreInfoDocActivity extends AppCompatActivity implements ValueEventListener {
    ...
    Intent iMoreInfo;
    private DatabaseReference nodeRoot, nodeUsers, nodeStatus, nodeGetMyName;
...
//            profileMoreInfoMessage.setOnClickListener(goToFriendProfile);
            ...
            btnBackToMessage.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent iChat = new Intent(MoreInfoDocActivity.this, ChatWithFriendActivity.class);
            ...
            adapter = new ListMediaStorageAdapter(MoreInfoDocActivity.this,R.layout.item_image_in_list_storage,listImages);
...
//                    DataSnapshot nodeHeadDo = dataSnapshot.child("head doctors").child(uidFriend);
                    if (nodeDoc.exists()) {
                        //Account account=new Account();
                        Intent iFriendProfile = new Intent(MoreInfoDocActivity.this, SearchProfileActivity.class);
