...
public class ChatWithDoctorActivity extends AppCompatActivity implements ValueEventListener,
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btnMoreInfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent iMoreInfo = new Intent(ChatWithDoctorActivity.this,MoreInfoActivity.class);
    ...
    protected void onStart() {
        super.onStart();
        messageController = new MessageController(ChatWithDoctorActivity.this,uidFriendChat,recyclerViewMessage);
    }
                ...
                ref.putFile(filePath)
                        ...
                        .addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(ChatWithDoctorActivity.this,
            ...
            try {
                ...
                uploadTask.addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        Toast.makeText(ChatWithDoctorActivity.this,"If you do not receive the photo, please check again!!",Toast.LENGTH_LONG).show();
                    }
                }).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    @Override
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
