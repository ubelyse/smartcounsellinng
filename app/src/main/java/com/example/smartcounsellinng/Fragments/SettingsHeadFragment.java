...
import com.example.smartcounsellinng.Reports.ShowDoctorasHead;
...
public class SettingsHeadFragment extends Fragment implements View.OnClickListener{
    private Button btnLogout, btnChangePassWord;
    private Button btnPrivatePolicy, btnAboutApp,btndoclist;
...
//    String status = "";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_settings_head, container, false);
        btnLogout = v.findViewById(R.id.btnLogout);
        btnChangePassWord = v.findViewById(R.id.btnAccountPolicy);
        btndoclist = v.findViewById(R.id.btnshowDocApp);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btnshowDocApp:
                Intent intent3 = new Intent(getActivity(), ShowDoctorasHead.class);
