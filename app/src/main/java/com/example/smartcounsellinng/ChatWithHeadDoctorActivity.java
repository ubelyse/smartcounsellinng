...
import com.example.smartcounsellinng.Activities.MoreInfoActivity;
...
public class ChatWithHeadDoctorActivity extends AppCompatActivity implements ValueEventListener,
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chat_with_head_doctor);
        ...
        btnMoreInfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent iMoreInfo = new Intent(ChatWithHeadDoctorActivity.this, MoreInfoActivity.class);
    ...
    protected void onStart() {
        super.onStart();
        messageController = new MessageController(ChatWithHeadDoctorActivity.this,uidFriendChat,recyclerViewMessage);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btnBackMessages:
                ...
                Intent iFriendFragment = new Intent(ChatWithHeadDoctorActivity.this, MainPatientActivity.class);
                Bundle bundle = new Bundle();
                ...
                ref.putFile(filePath)
                        ...
                        .addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(ChatWithHeadDoctorActivity.this,
                        ...
                        .addOnProgressListener(new OnProgressListener<UploadTask.TaskSnapshot>() {
                            ...
                            public void onProgress(UploadTask.TaskSnapshot taskSnapshot) {
                                ...
                                mAuthProgressDialog= new ProgressDialog(ChatWithHeadDoctorActivity.this);
            ...
            try {
                ...
                uploadTask.addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        Toast.makeText(ChatWithHeadDoctorActivity.this,"If you do not receive the photo, please check again!!",Toast.LENGTH_LONG).show();
                    }
                }).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    @Override
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
