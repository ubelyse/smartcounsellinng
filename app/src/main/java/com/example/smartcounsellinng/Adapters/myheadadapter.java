...
public class myheadadapter extends FirebaseRecyclerAdapter<Doctor,myheadadapter.myviewholder>
{

    public myheadadapter(@NonNull FirebaseRecyclerOptions<Doctor> options)
    {
        super(options);
    }
    ...
    {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.singlerowhead,parent,false);
...
//            emsg=(ImageView)itemView.findViewById(R.id.editmsg);
